...
![](https://github.com/kushpetal/twitter_postgres_parallel/workflows/tests_normalized/badge.svg)

![](https://github.com/kushpetal/twitter_postgres_parallel/workflows/tests_normalized_parallel/badge.svg)

![](https://github.com/kushpetal/twitter_postgres_parallel/workflows/tests_normalized_batch/badge.svg)

![](https://github.com/kushpetal/twitter_postgres_parallel/workflows/tests_normalized_batch_parallel/badge.svg)

![](https://github.com/kushpetal/twitter_postgres_parallel/workflows/tests_denormalized/badge.svg)

![](https://github.com/kushpetal/twitter_postgres_parallel/workflows/tests_denormalized_parallel/badge.svg)
...
| -----------------------| ------------------------- | ------------------------- |
| `pg_normalized`        | 7m 48.7s                          | 1m 0.21s                          | 
| `pg_normalized_batch`  | 1m 36.03s                          | 15.46s                          | 
| `pg_denormalized`      | 10.21s                          | 4.1s                          | 
